...
cubs = {"blue": 0, "red": 0, "green": 0}
def finder(root, cnt=1):
    cubs[root.attrib["color"]] += cnt  # нашли цвет добавили к счётчику
    [finder(child, cnt + 1) for child in root]  # поиск во вложениях
finder(ElementTree.fromstring(input()))  # считываем xml-строку
print(cubs["red"], cubs["green"], cubs["blue"])
